...
termcat.rewrite.cache = (function cache(){return cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);
});
...
var cache_update_BANG___delegate = function (f,args){return cljs.core.reset_BANG_.call(null,termcat.rewrite._BANG__STAR_cache_STAR_,cljs.core.apply.call(null,f,cljs.core.deref.call(null,termcat.rewrite._BANG__STAR_cache_STAR_),args));
};
...
;
termcat.rewrite.cache_get = (function cache_get(k){return cljs.core.deref.call(null,termcat.rewrite._BANG__STAR_cache_STAR_).call(null,k);
});
termcat.rewrite.memoize = (function memoize(f){return (function() { 
var G__8770__delegate = function (args){var temp__4090__auto__ = termcat.rewrite.cache_get.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [f,args], null));if(cljs.core.truth_(temp__4090__auto__))
{var result = temp__4090__auto__;return result;
} else
{var result = cljs.core.apply.call(null,f,args);termcat.rewrite.cache_update_BANG_.call(null,cljs.core.assoc,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [f,args], null),result);
return result;
}
};
...
termcat.rewrite.pad_1 = (function pad_1(v){return cljs.core.cons.call(null,null,cljs.core.conj.call(null,v,null));
});
termcat.rewrite.trim = (function() {
var trim = null;
var trim__1 = (function (v){return trim.call(null,v,0,(cljs.core.count.call(null,v) - 1));
});
var trim__3 = (function (v,lidx,ridx){while(true){
var lnil_QMARK_ = (cljs.core.get.call(null,v,lidx) == null);var rnil_QMARK_ = (cljs.core.get.call(null,v,ridx) == null);if((lidx > ridx))
...
;
termcat.rewrite.apply_rule_STAR_ = (function apply_rule_STAR_(rule,state,input){var or__3403__auto__ = rule.call(null,state,input);if(cljs.core.truth_(or__3403__auto__))
{return or__3403__auto__;
} else
...
var G__8776 = null;
var G__8776__2 = (function (rule,input){return termcat.rewrite.apply_rule.call(null,rule,rule.call(null),input);
});
var G__8776__3 = (function (rule,state,input){var vec__8775 = termcat.rewrite.apply_rule_STAR_.call(null,rule,state,termcat.rewrite.unwrap.call(null,input));var state2 = cljs.core.nth.call(null,vec__8775,0,null);var input2 = cljs.core.nth.call(null,vec__8775,1,null);return cljs.core.with_meta.call(null,termcat.rewrite.rewrap.call(null,input,input2),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"state","state",1123661827),state2], null));
});
...
var disjunction__delegate = function (orig_rules){var init_state = cljs.core.persistent_BANG_.call(null,clojure.core.reducers.reduce.call(null,cljs.core.assoc_BANG_,cljs.core.transient$.call(null,cljs.core.PersistentArrayMap.EMPTY),clojure.core.reducers.mapcat.call(null,(function (p1__8777_SHARP_){return p1__8777_SHARP_.call(null);
}),orig_rules)));return (function() {
var G__8786 = null;
var G__8786__0 = (function (){return init_state;
});
var G__8786__2 = (function (orig_state,orig_input){var next_rules = orig_rules;var G__8783 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [orig_state,orig_input], null);var vec__8784 = G__8783;var state = cljs.core.nth.call(null,vec__8784,0,null);var input = cljs.core.nth.call(null,vec__8784,1,null);var next_rules__$1 = next_rules;var G__8783__$1 = G__8783;while(true){
var next_rules__$2 = next_rules__$1;var vec__8785 = G__8783__$1;var state__$1 = cljs.core.nth.call(null,vec__8785,0,null);var input__$1 = cljs.core.nth.call(null,vec__8785,1,null);if(cljs.core.empty_QMARK_.call(null,next_rules__$2))
{return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [state__$1,input__$1], null);
} else
{var result = termcat.rewrite.apply_rule_STAR_.call(null,cljs.core.first.call(null,next_rules__$2),state__$1,input__$1);if(!(cljs.core._EQ_.call(null,cljs.core.second.call(null,result),input__$1)))
{return result;
} else
{{
...
var sequence__delegate = function (orig_rules){var init_state = cljs.core.persistent_BANG_.call(null,clojure.core.reducers.reduce.call(null,cljs.core.assoc_BANG_,cljs.core.transient$.call(null,cljs.core.PersistentArrayMap.EMPTY),clojure.core.reducers.mapcat.call(null,(function (p1__8790_SHARP_){return p1__8790_SHARP_.call(null);
}),orig_rules)));return (function() {
var G__8799 = null;
var G__8799__0 = (function (){return init_state;
});
var G__8799__2 = (function (orig_state,orig_input){var next_rules = orig_rules;var G__8796 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [orig_state,orig_input], null);var vec__8797 = G__8796;var state = cljs.core.nth.call(null,vec__8797,0,null);var input = cljs.core.nth.call(null,vec__8797,1,null);var next_rules__$1 = next_rules;var G__8796__$1 = G__8796;while(true){
var next_rules__$2 = next_rules__$1;var vec__8798 = G__8796__$1;var state__$1 = cljs.core.nth.call(null,vec__8798,0,null);var input__$1 = cljs.core.nth.call(null,vec__8798,1,null);if(cljs.core.empty_QMARK_.call(null,next_rules__$2))
{return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [state__$1,input__$1], null);
} else
{{
...
var G__8805 = null;
var G__8805__0 = (function (){return rule.call(null);
});
var G__8805__2 = (function (state,input){while(true){
var vec__8804 = termcat.rewrite.apply_rule_STAR_.call(null,rule,state,input);var new_state = cljs.core.nth.call(null,vec__8804,0,null);var new_input = cljs.core.nth.call(null,vec__8804,1,null);if((cljs.core.empty_QMARK_.call(null,new_input)) || (cljs.core._EQ_.call(null,input,new_input)))
...
var f = null;
var f__0 = (function (){return rule.call(null);
});
var f__2 = (function (state,input){return termcat.rewrite.apply_rule_STAR_.call(null,rule,state,cljs.core.persistent_BANG_.call(null,clojure.core.reducers.reduce.call(null,cljs.core.conj_BANG_,cljs.core.transient$.call(null,cljs.core.PersistentVector.EMPTY),clojure.core.reducers.map.call(null,(function (p1__8808_SHARP_){if(cljs.core.truth_(pred.call(null,p1__8808_SHARP_)))
...
var G__8809 = null;
var G__8809__0 = (function (){return new cljs.core.PersistentArrayMap.fromArray([rule,rule.call(null)], true, false);
});
var G__8809__2 = (function (state,input){var temp__4090__auto__ = rule.call(null,cljs.core.get.call(null,state,rule),input);if(cljs.core.truth_(temp__4090__auto__))
{var r = temp__4090__auto__;return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.assoc.call(null,state,rule,cljs.core.first.call(null,r)),cljs.core.second.call(null,r)], null);
} else
{return null;
}
});
...
var G__8812 = null;
var G__8812__0 = (function (){return rule.call(null);
});
var G__8812__2 = (function (orig_state,orig_input){var state = orig_state;var input = termcat.rewrite.pad_1.call(null,orig_input);var output = cljs.core.transient$.call(null,cljs.core.PersistentVector.EMPTY);while(true){
...
{var vec__8811 = termcat.rewrite.apply_rule_STAR_.call(null,rule,state,input);var new_state = cljs.core.nth.call(null,vec__8811,0,null);var new_input = cljs.core.nth.call(null,vec__8811,1,null);{
...
var f__2 = (function (orig_state,orig_input){var state = orig_state;var input = termcat.rewrite.pad_1.call(null,orig_input);var output = cljs.core.transient$.call(null,cljs.core.PersistentVector.EMPTY);while(true){
if(cljs.core.empty_QMARK_.call(null,input))
{return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [state,termcat.rewrite.trim.call(null,cljs.core.persistent_BANG_.call(null,output))], null);
} else
{var el1 = cljs.core.first.call(null,input);var input__$1 = (cljs.core.truth_(pred.call(null,el1))?cljs.core.cons.call(null,termcat.rewrite.apply_rule.call(null,f,scope.call(null,state),el1),cljs.core.next.call(null,input)):input);var vec__8823 = termcat.rewrite.apply_rule_STAR_.call(null,rule,state,input__$1);var new_state = cljs.core.nth.call(null,vec__8823,0,null);var new_input = cljs.core.nth.call(null,vec__8823,1,null);{
...
var G__8827 = null;
var G__8827__0 = (function (){return rule.call(null);
});
var G__8827__2 = (function (state,input){return clojure.core.reducers.reduce.call(null,rule,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [state,cljs.core.PersistentVector.EMPTY], null),cljs.core.conj.call(null,input,null));
});
