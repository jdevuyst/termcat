...
*/
termcat.rules.pretokenize.char_to_token = (function char_to_token(c){return termcat.term.token.cljs$core$IFn$_invoke$arity$2((function (){var G__10089 = c;if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(" ",G__10089))
{return cljs.core.constant$keyword$40;
} else
{if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("`",G__10089))
...
{if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("_",G__10089))
...
termcat.rules.pretokenize.map_to_tokens = (function map_to_tokens(code){return cljs.core.first(clojure.core.reducers.reduce.cljs$core$IFn$_invoke$arity$3((function (p__10092,c){var vec__10093 = p__10092;var result = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10093,0,null);var pos = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10093,1,null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.conj.cljs$core$IFn$_invoke$arity$2(result,cljs.core.with_meta(termcat.rules.pretokenize.char_to_token(c),new cljs.core.PersistentArrayMap(null, 3, [cljs.core.constant$keyword$81,code,cljs.core.constant$keyword$79,pos,cljs.core.constant$keyword$80,pos], null))),(pos + 1)], null);
