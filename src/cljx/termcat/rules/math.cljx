...
(t/defrule remove-manual-casts [state t1 t2 t3 t4]
...
(t/defrule introduce-math-operators [state t1 t2 t3 t4 t5 t6 t7]
...
(t/defrule introduce-msub-msup [state t1 t2 t3]
           [_
            [:block (_ :guard :math)]
            :right-quote
            _] [nil
...
(t/defrule introduce-mfrac [state t1 t2 t3]
           [_
            (:or :default
                 [:block _])
            :bar
...
(t/defrule math-cast-next-token [state t1 t2]
           [_ [:block (_ :guard :math)] (:or :default [:block _])]
           (concat [nil t1]
                   (math/math-cast t2)))

(t/defrule remove-superfluous-whitespace [state t1 t2 t3]
           [_ [:block (_ :guard :math)] :whitespace [:block (_ :guard :math)]]
           [nil t1 t3])

; (t/defrule flatten-math-fences [state t1]
;   [_
