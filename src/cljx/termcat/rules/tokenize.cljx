...
(t/defrule remove-escape-tokens
           [state t1 t2]
           [_ :escape _] [nil (t/token :default (t/payload t2))])

(t/defrule remove-annotated-tokens
           [state t1 t2]
           [_ :tilde :tilde] nil
...
(t/defrule introduce-emptyline-tokens
           [state t1 t2]
           [_ :emptyline :newline] [nil t2]
           [_ :newline :newline] [nil (with-meta (t/token :emptyline)
                                                 (meta t1))])

(t/defrule introduce-indent-tokens {:indent 0} [state t1 t2]
           ; [{:fin true} _ _] nil
...
(t/defrule introduce-item-tokens {:in-bullet false
                                  :item-type nil
...
(t/defrule remove-percent-tokens [state t1 t2 t3]
