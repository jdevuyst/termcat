...
(t/defrule introduce-nbsp-entities [state t1]
           [_ :tilde] [nil (t/token :html "&nbsp;")])

(t/defrule introduce-typographic-dashes [state t1]
...
(t/defrule introduce-typographic-quotes {:in-math-tag false} [state t1]
...
(t/defrule introduce-typographic-full-stops [state t1 t2 t3]
           [_ (:or :default
                   [:block _])
            :period
...
(t/defrule introduce-typographic-colons [state t1 t2 t3]
           [_ (:or :default
                   [:block _])
...
(t/defrule remove-error-tokens [state t1]
...
(t/defrule introduce-inner-math-tags [state t1]
...
(t/defrule remove-double-math-tokens [state t1 t2]
...
(t/defrule remove-canceling-math-tokens [state t1 t2]
...
(t/defrule to-html-tokens [state t1]
